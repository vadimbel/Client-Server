...
def calculate_checksum(data: bytes) -> int:
    """
    Create a temporary file with given data, calculate the checksum,
    delete the file, and return the checksum.
    """
    ...
    try:
        # Re-open the file to read bytes and calculate checksum
        with open(tmp_file_path, 'rb') as file:
            file_data = file.read()
            checksum = memcrc(file_data)
    finally:
